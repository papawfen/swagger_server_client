...
//go:generate swagger generate server --target ../../candy_server --name CandyServer --spec ../../../../PROJECTS/Go-bootcamp/Day04/src/candy_server/swagger.yml --principal interface{} --exclude-main
